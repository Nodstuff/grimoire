...
osascript -e 'quit app "knowledge-system"' 2>/dev/null || true
sleep 1; pkill -f ks-shell 2>/dev/null || true; sleep 0.5
rm -rf /Applications/knowledge-system.app
cp -R target/release/bundle/macos/knowledge-system.app /Applications/
open /Applications/knowledge-system.app
